export default function Contacts() {
  return (
    <section id="contacts" className="container-px py-12 sm:py-16 bg-gradient-to-b from-slate-900/50 to-slate-800/30">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          {/* Phone */}
          <div className="card p-6 text-center animate-fade-in-up delay-600">
            <div className="w-16 h-16 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-4 animate-glow">
        ...
        <div className="mt-12 text-center animate-fade-in-up delay-800">
          <div className="card p-6 max-w-2xl mx-auto">
            <h3 className="text-xl font-semibold text-white mb-4">Рабочие часы</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-slate-300">
              <div>
                <p className="font-medium">Пн - Пт</p>
                <p className="text-sm">9:00 - 20:00</p>
              </div>
              <div>
